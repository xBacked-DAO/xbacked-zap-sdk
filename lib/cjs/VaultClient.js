...
class VaultClient {
    constructor(params) {
        this.claimRewardsFromFarm = (address, vault, rewardAsset) => __awaiter(this, void 0, void 0, function* () {
            ...
            const userState = yield this.getUserState({ address, vault });
            ...
            atc.addMethodCall({
                ...
                suggestedParams: Object.assign(Object.assign({}, params), { fee: 2000, flatFee: true }),
    ...
    create(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const boxFeePaymentTxn = algosdk_1.default.makePaymentTxnWithSuggestedParams(from, appAddress, balanceForBoxCreated + 1100000, undefined, undefined, params);
            params.fee = 1000;
    ...
    deposit(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            updateStateAtc.addMethodCall({
                ...
                signer: algosdk_1.default.makeEmptyTransactionSigner(),
                suggestedParams: Object.assign(Object.assign({}, params), { fee: 8 }),
    ...
    updateLocalState(address, vault) {
        return __awaiter(this, void 0, void 0, function* () {
            const userState = yield this.getUserState({ address, vault });
            const params = yield this.client
                .getTransactionParams()
            ...
            atc.addMethodCall({
                ...
                signer: algosdk_1.default.makeEmptyTransactionSigner(),
                suggestedParams: Object.assign(Object.assign({}, params), { fee: 1000, flatFee: true }),
                appAccounts: [userState.escrowAddress, userState.interfaceAddress],
                appForeignApps: [userState.escrowId],
                appForeignAssets: [liquidityToken],
            });
